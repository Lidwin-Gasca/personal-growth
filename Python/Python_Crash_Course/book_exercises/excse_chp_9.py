...
#El método _init_() para Restaurante debe almacenar dos atributos: un nombre_restaurante y un tipo de cocina. 
#Cree un método llamado describe_restaurant () que imprima estas dos piezas de información, 
#y un método llamado open_restaurant () que imprima un mensaje que indique que el restaurante está abierto.
